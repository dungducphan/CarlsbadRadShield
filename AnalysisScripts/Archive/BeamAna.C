...
const double massOfPhantom = 168.117; // kg
...
void BeamAna::Loop() {
   ...
   absorbedEnergy_Human1 = absorbedEnergy_Human1 * scaleFactor * laserReprate / massOfPhantom; // Gy/s
   absorbedEnergy_Human2 = absorbedEnergy_Human2 * scaleFactor * laserReprate / massOfPhantom; // Gy/s
